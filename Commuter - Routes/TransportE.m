...
-(id)initWithRouteLeg:(RouteLegE *)routeLeg andWidth:(float)width{
    self = [super init];
    if (self) {
        NSArray* nibViews = [[NSBundle mainBundle] loadNibNamed:@"TransportE" owner:self options:nil];
...
-(void)setUpViewForRoute:(RouteLegE *)routeLeg andWidth:(float)width{
...
//    }
    ...
    [imageView setImage:[self lightColorImageForLegTransportType:routeLeg.legType]];

...
{
    //Init Singletons
    [AppFeatureManager sharedManager];
...
//    }
    ...
    [[ReittiAnalyticsManager sharedManager] trackUserProperty:kUserPropertyIsProUser value:[AppFeatureManager proFeaturesAvailable] ? @"true" : @"false"];
